...
def battery_or_charge(input_string):
    ...
    batterySTR = """電動車最常被拿來比較的是「續航里程」，
    若要衝高續航里程的數字，基本上只要增加電池容量就好，所以續航里程並不是一個適合拿來比較的指標，
    每一度電可跑幾公里的「電耗」才是技術力的展現，因為電池成本高昂，車廠要盡量做出較低的電耗，
    售價才有競爭力。某些人講到中共換電池的方式，這方式看似不錯，可是中共的充電站也曾發生換到電量
    不夠或者沒有充滿電的電池可更換，所以更換式根本不切實際，以gogoro來說A的充電站沒充滿的電池很多，
    我可以把其它充電站充滿電的電池送過來，汽車的電池有可能這麼送嗎？可別忘了汽車的電池會比機車來得大
    """.replace(" ", "").replace("\n", "")

    chargeSTR = """為了打通電動車最重要一哩路「充電焦慮」，行政院召集各部會，由經濟部規畫國內首份
    「公共充電樁建置」藍圖，以短中長三階段全面推動。首階段到2025年，預計結合中央與地方力量，在公有停車場、
    大賣場、加油站、台鐵高鐵站，大量建置公共充電樁，慢充、快充兩者總數要達7800座 ，讓車輛不斷電。
    充電焦慮 困擾民眾。國內電動汽車目前僅1.5萬輛，但去年呈倍增成長，雖然電動車時代來臨，
    但要全面普及仍有重重障礙，影響最大的是民眾的「充電焦慮」。
    """.replace(" ", "").replace("\n", "")

...
if __name__ == "__main__":
  ...
  #  mixedDICT = {**nbaDICT, **mlbDICT}
   ...
   #     json.dump(mixedDICT, f, ensure_ascii=False)
    ...
    unknownSTR02 = """一般對充電的疑慮是什麼?電氣走火、充電異常危險吧。歸根究柢就是電流異常或電路問題。但一般家庭中最不缺的就是電器，冰箱會電線走火嗎?手機會充電到一半爆炸嗎?除濕機會開到一半自燃嗎?電磁爐、微波爐會使用到一半爆炸嗎?以上都會，也都確確實實發生過，但特斯拉好像還沒有充電起火的案例吧。有發生起火的沒要求要保險，沒發生起火的反而要求要保險?
